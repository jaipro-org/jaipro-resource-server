package com.bindord.jaipro.resourceserver.aop;
...
public class AspectController {
    ...
    @Before(value = "within(com.bindord.jaipro.resourceserver.controller..*) && !@annotation(com.bindord.jaipro.resourceserver.annotation.NoLogging)",
            argNames = "joinPoint")
...
//                mapper.enable(SerializationFeature.INDENT_OUTPUT);
    ...
    @AfterReturning(value = "within(com.bindord.jaipro.resourceserver.controller..*) && !@annotation(com.bindord.jaipro.resourceserver.annotation.NoLogging)",
